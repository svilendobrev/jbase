...
//svd: use the static fixlog() below
//package com.svilendobrev.jbase;
//
//as of http://stackoverflow.com/questions/4561345/how-to-configure-java-util-logging-on-android
//by Christian Bauer
 ...
 */
public class FixedAndroidLoggingHandler extends Handler {

public static void fixlog( String tag) {
    //aaaargh see http://stackoverflow.com/questions/4561345/how-to-configure-java-util-logging-on-android
    Logger rootLogger = LogManager.getLogManager().getLogger("");
    //remove all others
    //for (Handler handler : rootLogger.getHandlers()) rootLogger.removeHandler(handler);
    rootLogger.addHandler( new FixedAndroidLoggingHandler());
    //now this will work:
    Logger.getLogger( tag).setLevel( Level.FINE);
}

public static void fixlog() { fixlog(""); }
     ...
     */
    public FixedAndroidLoggingHandler() {
